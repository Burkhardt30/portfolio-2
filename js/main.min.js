...
$(function(){$(document).on("scroll",function(){50<$(document).scrollTop()?$(".header__top").addClass("header__top--thin"):$(".header__top").removeClass("header__top--thin")}),$(".menu__list a, .header__logo-link, .footer__logo-link").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},1500)}),$(".header__burger, .menu__list a").on("click",function(e){e.preventDefault(),$(".header__navigation").toggleClass("header__navigation--open"),$(".blackout").toggleClass("blackout--visible")}),$(".blackout").on("click",function(){$(".header__navigation").toggleClass("header__navigation--open"),$(".blackout").toggleClass("blackout--visible")}),$(".faq__item-btn").on("click",function(){$(this).prev().children(".faq__item-text").hasClass("faq__item-text--active")?($(this).prev().children(".faq__item-text").removeClass("faq__item-text--active"),$(this).removeClass("faq__item-btn--active"),$(this).prev().children(".faq__item-text").slideUp()):($(".faq__item-btn").prev().children(".faq__item-text").removeClass("faq__item-text--active"),$(".faq__item-btn").removeClass("faq__item-btn--active"),$(".faq__item-btn").prev().children(".faq__item-text").slideUp(),$(this).prev().children(".faq__item-text").toggleClass("faq__item-text--active"),$(this).toggleClass("faq__item-btn--active"),$(this).prev().children(".faq__item-text").slideToggle())}),$(".testimonials__slider").slick({arrows:!1,slidesToShow:2,infinite:!1,responsive:[{breakpoint:768,settings:{slidesToShow:1,dots:!0}}]})});